...
function boot(){
    ...
    oSubmeter.onclick = conversorDeASCII;
...
function paginaDoConversorDeMoeda(){
    document.location.href = "conversorDeMoeda.html";
    return false;
} //paginaDoConversorDeMoeda

function paginaDoConversorDeMorse(){
    document.location.href = "conversorDeMorse.html";
    return false;
} //paginaDoConversorDeMorse
